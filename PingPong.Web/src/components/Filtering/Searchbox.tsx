		...
		return (
			<form className="d-sm-inline-block form-inline my-md-0 mw-100">
				<div className="input-group">
					<input onKeyPress={ (e) => { if(e.keyCode === 13) this.props.onSearchClicked();  } } onChange={ (e) => { this.props.onSearchChanged(e.target.value) }} type="text" className="form-control bg-light border-0 small" placeholder={ this.props.placeholder } />
